class MxCommonColumnSet < ActiveRecord::Base
  ...
  has_many :header_columns, class_name: 'MxCommonHeaderColumn', foreign_key: :owner_id, order: :position, dependent: :destroy
  has_many :footer_columns, class_name: 'MxCommonFooterColumn', foreign_key: :owner_id, order: :position, dependent: :destroy
